...
from engine.shared.constants import PRIORITY_LIVE_INTEGRATION, SourceSystem
...
# Slack / Linear / GitHub webhooks (PRIORITY_LIVE_INTEGRATION, the default —
# explicit here so the intent is obvious), and incident records remain
# relevant for post-mortems
...
for _source in (SourceSystem.PAGERDUTY, SourceSystem.INCIDENT_IO):
    register_source(
        SourceProfile(
            ...
            ingestion_priority=PRIORITY_LIVE_INTEGRATION,
