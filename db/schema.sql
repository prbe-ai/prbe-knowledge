...
-- Workflow memory (team rules) had five tables here -- situations, clauses,
-- clause_situation_edges, clause_evidence, serve_ledger -- and two trigger
-- functions, created by migrations 0114-0119. Migration 0142 dropped them
-- with their rows (owner decision 2026-09-26).
...
-- Immutable transcript acceptance (migration 0128).
