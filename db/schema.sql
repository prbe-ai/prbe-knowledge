...
-- policy is the deny); claims is the one mutable table. Dedupe is two
-- PARTIAL unique indexes because actor-keyed rows carry a NULL session_id.
-- The DDL below is the migration's text verbatim; keep them identical (the
-- drift guard compares column ordinals).
-- ---------------------------------------------------------------------------
