...
## Re-grade with a non-Claude grader (gpt-4.1-mini, 2026-09-22)

Same 368 traces, same arms, same prompts. Per-document verdicts kept this time
(`t6-gpt-regrade.jsonl`, scratchpad).

| arm | precision (Claude) | precision (GPT) | answerable (Claude) | answerable (GPT) |
|---|---|---|---|---|
| A today | 6.0% | 2.2% | 10.9% | 18.8% |
| B floor | 7.4% | 4.1% | 10.6% | 20.1% |
| D Jev rank | 15.5% | 13.4% | 15.8% | 25.5% |

D vs B precision: p=4e-29 under GPT (6e-18 under Claude). D vs B answerable:
p=0.079 under GPT, so directional only. A vs B precision: GPT says today is
significantly WORSE than the floor (p=0.00025). Split-half D 12.5% / 14.4%.
Verdict: the Jev ranking win is not a Claude-grader artifact. The gate passes.
